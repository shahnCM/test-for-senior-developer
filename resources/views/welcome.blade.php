...
<body>
    <div class="content">
        ...
        <br/>
        2. <a target="_blank" href="{{url('record-transfer')}}">record-transfer</a>. There is a record file <code>/storage/app/public/records.json</code>. Transfer this data to <code>records</code> table in most efficient way.
        <br>
        <small class="text-danger">
            (please install laravel/helpers; From your terminal in the app directory run: "composer require laravel/helpers"
            For " str_slug() " to work properly laravel/helpers is necessary. 
            *** laravel/helpers no more ships with core laravel*** Thank You !)
        </small>
        <br/><br/>
        3. <a target="_blank" href="{{url('define-callback-js')}}">define-callback-js</a>. Define <code>checkAge()</code> function to use like this.
        <pre>
